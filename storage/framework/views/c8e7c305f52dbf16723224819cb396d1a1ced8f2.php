        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-sitemap fa-fw"></i> Articles<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo e(route('admin.articles.create')); ?>">Create</a>
                            </li>
...
<?php /**PATH C:\xampp\htdocs\aqarmap\resources\views/layouts/admin.blade.php ENDPATH**/ ?>